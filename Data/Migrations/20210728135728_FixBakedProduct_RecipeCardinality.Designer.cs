...
namespace PadariaTech.Data.Migrations
{
    ...
    [Migration("20210728135728_FixBakedProduct_RecipeCardinality")]
    partial class FixBakedProduct_RecipeCardinality
    {
            ...
            modelBuilder.Entity("PadariaTech.Domain.Models.BakedProduct", b =>
                {
                    b.HasOne("PadariaTech.Domain.Models.Recipe", "Recipe")
                        ...
                        .HasForeignKey("PadariaTech.Domain.Models.BakedProduct", "RecipeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
